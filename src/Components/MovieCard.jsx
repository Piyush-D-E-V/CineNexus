    ...
    >
      <div className="relative overflow-hidden rounded-2xl aspect-2/3 border-2 border-slate-800 group-hover:border-purple-500 transition-colors bg-slate-900">
        ...
        <button 
          ...
          className={`absolute -top-1 -right-1 rounded-bl-xl w-14 h-6 flex items-center justify-center font-bold z-20 border transition-all cursor-pointer text-center ${
            isAdded(movie.id)
